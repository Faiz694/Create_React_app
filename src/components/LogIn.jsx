    ...
    <>
      <div className="fixed inset-0 z-[99] w-full h-full bg-black/40 flex justify-center items-end md:items-center">
        ...
        {/* onClick={handleCloseModal} */}
          <button className="absolute hidden md:block end-0 top-0 translate-y-[-150%] z-[101] bg-white rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-5 md:px-10 py-6 md:py-4">
            <form className="flex flex-col items-center gap-8 md:mb-5">
              <div className="flex justify-between items-center w-full">
                ...
                <button type="button" className="md:hidden bg-white rounded-full">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <button onClick={switchToSignIn} className="md:hidden underline" type="button">
                  or, Create Account
                </button>
              </div>
            ...
            <div className="hidden md:flex flex-col justify-between w-full gap-4">
              <span className="w-full flex items-center justify-end gap-1 text-sm py-2">
                <span className="text-black/70">Don’t have an account yet?</span>
                {/* onClick={handleSignInClick} */}
                <button onClick={switchToSignIn}  className="text-blue-600 font-semibold">
                  Create new for free!
                </button>
              </span>
              <img className="w-full" src={img} alt="signIn-img" />
            </div>
          </div>
        </div>
      </div>
